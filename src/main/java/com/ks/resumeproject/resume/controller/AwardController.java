...
public class AwardController {
    ...
    public String insertAward(@RequestBody AwardDto awardDto){
    ...
    public String updateAward(@RequestBody AwardDto awardDto){
    ...
    public String deleteAward(@RequestBody AwardDto awardDto){
    ...
    public String updateAwardList(@RequestBody List<Map<String, Object>> updateList){
