...
public class AccountReader {
    ...
    public ItemReader<AccountDto> itemReader() throws Exception{
        MyBatisCursorItemReader<AccountDto> reader = new MyBatisCursorItemReader<>();
        reader.setQueryId("com.ks.resumeproject.batch.repository.BatchMapper.selectDelAccountList");
