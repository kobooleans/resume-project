...
public class FileReader {
    ...
    public ItemReader<FileDto> itemReader() throws Exception{
        MyBatisCursorItemReader<FileDto> reader = new MyBatisCursorItemReader<>();
        reader.setQueryId("com.ks.resumeproject.batch.repository.BatchMapper.selectDelFileList");
